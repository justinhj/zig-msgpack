...
const MsgPackObject = root.MsgPackObject;
const MsgPackMapEntry = root.MsgPackMapEntry;
const MsgPackExtension = root.MsgPackExtension;
const freeObject = root.freeObject;
const pack = root.pack;
const unpack = root.unpack;
const Packer = root.Packer;
const packRpcRequest = root.packRpcRequest;
const packRpcResponse = root.packRpcResponse;
